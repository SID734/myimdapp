...
<form action="upload.php" method="post" enctype="multipart/form-data" style="border:1px solid #ccc;padding-top: 30px;">
    <div class="container" style="background-color:#D5F5E3;">
    
    <p>Please provide the details.</p>
    <hr>

    <label for="NameP"><b>Name of Person</b></label>
    <input type="text" placeholder="Enter Name" name="nameP" required>

    <label for="AdhaarNo"><b>Adhaar Number</b></label>
    <input type="text" placeholder="Enter Adhaar Number" name="adhaarNo" required>
