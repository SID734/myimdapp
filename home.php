...
<div class="container-fluid" style="margin-top: 40px;margin-left: 10px;margin-bottom: 5px;">
  <div class="row" style="height: 200px;width: 100%">
    <div class="col-sm-4" style="height: 100%;width: 100%">
      <a href="input.php"><button class="btn btn-outline-success my-2 my-sm-0" style="width: 100%;height: 100%;font-size: 30px;border-radius: 25px">Upload</button></a>
    </div>
    <div class="col-sm-4" style="height: 100%;width: 100%">
      <a href="validate.php"><button class="btn btn-outline-success my-2 my-sm-0" style="width: 100%;height: 100%;font-size: 30px;border-radius: 25px">Validate</button></a>
    </div>
    <div class="col-sm-4" style="height: 100%;width: 100%">
      <a href="myFiles.php"><button class="btn btn-outline-success my-2 my-sm-0" style="width: 100%;height: 100%;font-size: 30px;border-radius: 25px">My Blocks</button></a>
    </div>
  </div>
</div>
...
<br><br><u><h2>OR</h2></u>
<br>
<h3>Want to send or check file requests?</h3><a href="share.php">Click here</a>
</div>
